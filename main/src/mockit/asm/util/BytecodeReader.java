...
import static mockit.asm.jvmConstants.ConstantPoolTypes.CONDY;
import static mockit.asm.jvmConstants.ConstantPoolTypes.DOUBLE;
import static mockit.asm.jvmConstants.ConstantPoolTypes.FIELD;
import static mockit.asm.jvmConstants.ConstantPoolTypes.FLOAT;
import static mockit.asm.jvmConstants.ConstantPoolTypes.HANDLE;
import static mockit.asm.jvmConstants.ConstantPoolTypes.IMETH;
import static mockit.asm.jvmConstants.ConstantPoolTypes.INDY;
import static mockit.asm.jvmConstants.ConstantPoolTypes.INT;
import static mockit.asm.jvmConstants.ConstantPoolTypes.LONG;
import static mockit.asm.jvmConstants.ConstantPoolTypes.METH;
import static mockit.asm.jvmConstants.ConstantPoolTypes.MTYPE;
import static mockit.asm.jvmConstants.ConstantPoolTypes.NAME_TYPE;
import static mockit.asm.jvmConstants.ConstantPoolTypes.STR;
...
public class BytecodeReader {
    ...
    */
    ...
    @Nonnull
    public final DynamicConstHandle readDynamicConstHandle(int type, int codeIndex) {
        
        int bsmIndex = readUnsignedShort(codeIndex);
        int refItem = readItem(codeIndex + 2);
        String name = readNonnullUTF8(refItem);
        String desc = readNonnullUTF8(refItem + 2);
        
        return new DynamicConstHandle(type, name, desc, bsmIndex);
    }
    ...
    */
    ...
    protected final Object readConst(@Nonnegative int itemIndex) {
        ...
        case CONDY:
            return readDynamicConstHandle(CONDY, constCodeIndex);
        default:
